var arrLang = {
    'EN': {
      ...
      'Blockchain_slogan': 'Link up the world, play safe.',
    ...
    'SC': {
      ...
      'feature_2.1': '多项清晰的',
      'feature_2.2': '游戏记录',
      'feature_2_p': '多项清晰的游戏记录在游戏大堂，玩家只要挑选专业版路單，便可见龙虎过往100局的结果统计数据；进入现场游戏版面，更可见各种路單，包括「珠盘路」、「大路」、「大眼路」、「小路」及「小強路」，游戏趋势尽在掌握。',
      'feature_3.1': '随时「问路」',
      'feature_3.2': '预测结果 ',
